...
export function TopChannels({ data, className }: TopChannelsProps) {
  return (
    <div
      className={cn(
          ...
          {data.map((channel, i) => (
            ...
            >
              <TableCell className="flex min-w-fit items-center gap-3">
                <div className="flex size-8 items-center justify-center rounded-full bg-gray-2 dark:bg-dark-3">
