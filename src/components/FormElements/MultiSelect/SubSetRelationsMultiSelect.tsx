...
const RelationsMultiSelect: React.FC<DropdownProps> = ({ 
  ...
  const relationshipOptions = useMemo(() => [
    ...
    { value: "step_father", text: "Step Father" },
    { value: "step_mother", text: "Step Mother" },
    { value: "legal_guardian", text: "Legal Guardian" },
    { value: "family_friend", text: "Family Friend" },
    { value: "other_relative", text: "Other Relative" }
  ], []); // Empty dependency array since this is static

  useEffect(() => {
    setOptions(relationshipOptions.map(option => ({ ...option, selected: false })));
  }, [relationshipOptions]);
